...
* [3 Static Testing](3-static-testing/README.md)
  * [3.1 Static Testing Basics](3-static-testing/3.1-static-testing-basics/README.md)
    ...
    * [3.1.3 Differences between Static and Dynamic Testing](3-static-testing/3.1-static-testing-basics/3.1.3-differences-between-static-and-dynamic-testing.md)
...
* [4 Test Techniques](4-test-techniques/README.md)
  * [4.1 Categories of Test Techniques](4-test-techniques/4.1-categories-of-test-techniques/README.md)
    * [4.1.1 Categories of Test Techniques and Their Characteristics](4-test-techniques/4.1-categories-of-test-techniques/4.1.1-categories-of-test-techniques-and-their-characteristics.md)
  * [4.2 Black-box Test Techniques](4-test-techniques/4.2-black-box-test-techniques/README.md)
    * [4.2.1 Equivalence Partitioning](4-test-techniques/4.2-black-box-test-techniques/4.2.1-equivalence-partitioning.md)
    * [4.2.3 Decision Table Testing](4-test-techniques/4.2-black-box-test-techniques/4.2.3-decision-table-testing.md)
    * [4.2.4 State Transition Testing](4-test-techniques/4.2-black-box-test-techniques/4.2.4-state-transition-testing.md)
    * [4.2.2 Boundary Value Analysis](4-test-techniques/4.2-black-box-test-techniques/4.2.2-boundary-value-analysis.md)
    * [4.2.5 Use Case Testing](4-test-techniques/4.2-black-box-test-techniques/4.2.5-use-case-testing.md)
  * [4.3 White-box Test Techniques](4-test-techniques/4.3-white-box-test-techniques/README.md)
    * [4.3.1 Statement Testing and Coverage](4-test-techniques/4.3-white-box-test-techniques/4.3.1-statement-testing-and-coverage.md)
    * [4.3.2 Decision Testing and Coverage](4-test-techniques/4.3-white-box-test-techniques/4.3.2-decision-testing-and-coverage.md)
    * [4.3.3 The Value of Statement and Decision Testing](4-test-techniques/4.3-white-box-test-techniques/4.3.3-the-value-of-statement-and-decision-testing.md)
  * [4.4 Experience-based Test Techniques](4-test-techniques/4.4-experience-based-test-techniques/README.md)
    * [4.4.1 Error Guessing](4-test-techniques/4.4-experience-based-test-techniques/4.4.1-error-guessing.md)
    * [4.4.2 Exploratory Testing](4-test-techniques/4.4-experience-based-test-techniques/4.4.2-exploratory-testing.md)
    * [4.4.3 Checklist-based Testing](4-test-techniques/4.4-experience-based-test-techniques/4.4.3-checklist-based-testing.md)
...
* [6 Tool Support for Testing](6-tool-support-for-testing/README.md)
  * [6.1 Test Tool Considerations](6-tool-support-for-testing/6.1-test-tool-considerations/README.md)
    * [6.1.1 Test Tool Classification](6-tool-support-for-testing/6.1-test-tool-considerations/6.1.1-test-tool-classification.md)
    * [6.1.2 Benefits and Risks of Test Automation](6-tool-support-for-testing/6.1-test-tool-considerations/6.1.2-benefits-and-risks-of-test-automation.md)
    * [6.1.3 Special Considerations for Test Execution and Test Management Tools](6-tool-support-for-testing/6.1-test-tool-considerations/6.1.3-special-considerations-for-test-execution-and-test-management-tools.md)
  * [6.2 Effective Use of Tools](6-tool-support-for-testing/6.2-effective-use-of-tools/README.md)
    * [6.2.1 Main Principles for Tool Selection](6-tool-support-for-testing/6.2-effective-use-of-tools/6.2.1-main-principles-for-tool-selection.md)
    * [6.2.2 Pilot Projects for Introducing a Tool into an Organization](6-tool-support-for-testing/6.2-effective-use-of-tools/6.2.2-pilot-projects-for-introducing-a-tool-into-an-organization.md)
    * [6.2.3 Success Factors for Tools](6-tool-support-for-testing/6.2-effective-use-of-tools/6.2.3-success-factors-for-tools.md)
